...
public class EntityShader extends ShaderProgram {
	...
	private static final String VERTEX_PATH = "/shader/entity.vsh.txt";
	private static final String FRAGMENT_PATH = "/shader/entity.fsh.txt";
	...
	protected void getUniformLocations() {
		...
		location_isWater = super.getUniformLocation("isWater");
	}
	...
	public void loadIsWater(boolean isWater) {
		super.loadBoolean(location_isWater, isWater);
	}
